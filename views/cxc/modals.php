<fieldset id="mdl-venta" title="Confirmar Venta (Cuenta por Cobrar)">
  <div id="form-contained">
    <div class="row mb-3">
      ...
      <div class="col input-group">
        ...
        <input value="" type="date" name="freg"
          id="freg" class="form-control">
      </div>
      <div class="col input-group">
        <label class="input-group-text" for="fcobro">Fecha de Cobro</label>
        <input required type="date" name="fcobro" id="fcobro"
          class="form-control">
      </div>
...
<fieldset id="mdl-solvent" title="Cuentas por Cobrar Confirmadas Recientemente">
  <div class="row mb-3">
